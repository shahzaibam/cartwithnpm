            ...
            <div className="container-fluid mt-4 mb-3">
                <div className="row">
                    <div className="col-md-5 pr-2">
                        ...
                        <div className="demo">
                            <ul id="lightSlider">
                                <img src="https://www.tatonka.com/en/wp-content/uploads/sites/3/1954015b-800x800.jpg" height="400px" width="400px" />
                            </ul>
                        </div>

                    </div>
                    <div className="col-md-7">
                        <div className="about"> <h3 className="font-weight-bold">TravelBag</h3>
                            <h4 className="font-weight-bold">49.99€</h4>
                        </div>
                        <hr />
