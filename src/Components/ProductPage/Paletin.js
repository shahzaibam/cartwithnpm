            ...
            <div className="container-fluid mt-4 mb-3">
                <div className="row">
                    <div className="col-md-5 pr-2">
                        ...
                        <div className="demo">
                            <ul id="lightSlider">
                                <img src="https://cdn.manomano.com/paleta-wolfpack-plus-mango-de-goma-344-165x120mm-P-3379115-12966407_1.jpg" height="400px" width="400px" />
                            </ul>
                        </div>

                    </div>
                    <div className="col-md-7">
                        <div className="about"> <h3 className="font-weight-bold">Paletin</h3>
                            <h4 className="font-weight-bold">9.99€</h4>
                        </div>
                        <hr />
