        ...
        <>
            <div class="container-fluid mt-4 mb-3">
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="about"> <h3 class="font-weight-bold">Xiaomi Mi Electric Scooter
                        </h3>
                            <h4 class="font-weight-bold">659€
                            </h4>
                        </div>
                        <hr />
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <Link to="/">
                                        <div class="card" style={{ cursor: 'pointer' }}>
                                            <div class="card-body">
                                                <h5 class="card-title">5020mAh</h5>
                                            </div>
                                        </div>
                                    </Link>
                                </div>
                                <div class="col-sm-4">
                                    <Link to="/">
                                        <div class="card" style={{ cursor: 'pointer' }}>
                                            <div class="card-body">
                                                <h5 class="card-title">1020mAh</h5>
                                            </div>
                                        </div>
                                    </Link>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <Link to="/">
                                        <div class="card" style={{ cursor: 'pointer' }}>
                                            <div class="card-body">
                                                <h5 class="card-title">1520mAh</h5>
                                            </div>
                                        </div>
                                    </Link>
                                </div>
