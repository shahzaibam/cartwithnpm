            ...
            <div className="container-fluid mt-4 mb-3">
                <div className="row">
                    <div className="col-md-5 pr-2">
                        ...
                        <div className="demo">
                            <ul id="lightSlider">
                                <img src="https://www.backmarket.es/cdn-cgi/image/format=auto,quality=75,width=1920/https://d1eh9yux7w8iql.cloudfront.net/product_images/None_f130a79e-2477-4328-a59a-459bc2a3065f-thumb.jpg" height="400px" width="400px" />
                            </ul>
                        </div>

                    </div>
                    <div className="col-md-7">
                        <div className="about"> <h3 className="font-weight-bold">Xiaomi Mi Electric Scooter
                        </h3>
                            <h4 className="font-weight-bold">659€
                            </h4>
                        </div>
                        <hr />
                            ...
                            <div className="row">
                                    ...
                                    <Link to="/">
                                        <div className="card" style={{ cursor: 'pointer' }}>
                                            <div className="card-body">
                                                <h5 className="card-title">5020mAh</h5>
                                            </div>
                                        </div>
                                    </Link>
                                </div>
                                <div className="col-sm-4">
                                    <Link to="/">
                                        <div className="card" style={{ cursor: 'pointer' }}>
                                            <div className="card-body">
                                                <h5 className="card-title">1020mAh</h5>
                                            </div>
                                        </div>
                                    </Link>
                                </div>
                                ...
                                <div className="col-sm-4">
                                    <Link to="/">
                                        <div className="card" style={{ cursor: 'pointer' }}>
                                            <div className="card-body">
                                                <h5 className="card-title">1520mAh</h5>
                                            </div>
                                        </div>
                                    </Link>
                                </div>
...
export default XiaomiMiScooter
