            ...
            <div className="container-fluid mt-4 mb-3">
                <div className="row">
                    <div className="col-md-5 pr-2">
                        ...
                        <div className="demo">
                            <ul id="lightSlider">
                                <img src="https://www.ikea.com/es/es/images/products/lack-mesa-auxiliar-negro__22518_pe107397_s5.jpg?f=xxs" height="400px" width="400px" />
                            </ul>
                        </div>

                    </div>
                    <div className="col-md-7">
                        <div className="about"> <h3 className="font-weight-bold">Mesa Negra</h3>
                            <h4 className="font-weight-bold">7€</h4>
                        </div>
                        <hr />
