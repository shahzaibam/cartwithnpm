            ...
            <div class="container-fluid mt-4 mb-3">
                <div class="row">
                    <div class="col-md-5 pr-2">
                        ...
                        <div class="demo">
                            <ul id="lightSlider">
                                <img src="https://www.backmarket.es/cdn-cgi/image/format=auto,quality=75,width=1920/https://d1eh9yux7w8iql.cloudfront.net/product_images/product_images/199260_1c8201c7-bd8d-4fed-88da-e8394621c080-thumb.jpg" height="400px" width="400px" />
                            </ul>
                        </div>

                    </div>
                    <div class="col-md-7">
                        <div class="about"> <h3 class="font-weight-bold">MacBook Air 2017
                        </h3>
                            <h4 class="font-weight-bold">899€</h4>
                        </div>
                        <hr />
