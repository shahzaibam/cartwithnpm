            ...
            <div class="container-fluid mt-4 mb-3">
                <div class="row">
                    <div class="col-md-5 pr-2">
                        ...
                        <div class="demo">
                            <ul id="lightSlider">
                                <img src="https://cdn.shopify.com/s/files/1/0543/6650/3099/products/silver-adjustable-crystal-snake-sterling-silver-ring-e-e-jewellery.jpg?v=1622635429" height="400px" width="400px" />
                            </ul>
                        </div>

                    </div>
                    <div class="col-md-7">
                        <div class="about"> <h3 class="font-weight-bold">Silver Snake Ring</h3>
                            <h4 class="font-weight-bold">42.55€</h4>
                        </div>
                        <hr />
