            ...
            <div className="container-fluid mt-4 mb-3">
                <div className="row">
                    <div className="col-md-5 pr-2">
                        ...
                        <div className="demo">
                            <ul id="lightSlider">
                                <img src="https://image.made-in-china.com/202f0j10lrSGzsyKELkW/Modern-Luxury-Home-Fabric-Lounge-Living-Room-Furniture-Recliner-Sofa.jpg" height="400px" width="400px" />
                            </ul>
                        </div>

                    </div>
                    <div className="col-md-7">
                        <div className="about"> <h3 className="font-weight-bold">Single Sofa</h3>
                            <h4 className="font-weight-bold">99€</h4>
                        </div>
                        <hr />
