            ...
            <div className="container-fluid mt-4 mb-3">
                <div className="row">
                    <div className="col-md-5 pr-2">
                        ...
                        <div className="demo">
                            <ul id="lightSlider">
                                <img src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcQaW3-V_U-VrqK_FUE8hC5sFl7vzaxIiKjN0rEBzt5UD2U-O7lkXPDedWLzh1TwazyXTQgRMf6in-1jpWyxWaA1ETxss1mIwE98_8tsKpWYbg3_BHFjEsI0&usqp=CAE" height="400px" width="400px" />
                            </ul>
                        </div>

                    </div>
                    <div className="col-md-7">
                        <div className="about"> <h3 className="font-weight-bold">Cortacesped</h3>
                            <h4 className="font-weight-bold">659€</h4>
                        </div>
                        <hr />
