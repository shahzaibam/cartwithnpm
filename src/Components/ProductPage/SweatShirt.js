            ...
            <div className="container-fluid mt-4 mb-3">
                <div className="row">
                    <div className="col-md-5 pr-2">
                        ...
                        <div className="demo">
                            <ul id="lightSlider">
                                <img src="https://assets.adidas.com/images/w_600,f_auto,q_auto/3fc8bd3ba6294a13ba5da83500f40d24_9366/Buzo_Trifolio_Warm-Up_Crew_Gris_CY4573_01_laydown.jpg" height="400px" width="400px" />
                            </ul>
                        </div>

                    </div>
                    <div className="col-md-7">
                        <div className="about"> <h3 className="font-weight-bold">Adidas Sweatshirt</h3>
                            <h4 className="font-weight-bold">24.95€</h4>
                        </div>
                        <hr />
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-2">
                                    <Link to="/">
                                        <div className="card" style={{ cursor: 'pointer' }}>
                                            <div className="card-body">
                                                <h5 className="card-title">XXL</h5>
                                            </div>
                                        </div>
                                    </Link>
                                </div>
