...
import CartProviderXiaomiScooter from './Components/ProductPage/XiaomiScooter/CartProviderXiaomiScooter';
  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        <Route exact path="/XiaomiScooter" component={CartProviderXiaomiScooter} />
